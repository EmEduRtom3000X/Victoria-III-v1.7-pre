...
public class Main {
	...
	public static void main(String[] why) {
		...
		hints.add(new Hint(" #0","Катапульта не может маршировать","src/Assets/Art/Hint/0.PNG", 280)); //Catapults can't walk on marches
		hints.add(new Hint(" #1","Копейщик полезен для подсчета вражеской кавалерии","src/Assets/Art/Hint/1.PNG", 280)); //Spearmen are useful to counter enemy cavalry
		...
		hints.add(new Hint(" #4","Топорщику прекрасна рука, чтобы вручить сражение","src/Assets/Art/Hint/4.PNG", 280)); //Axemen excel at hand to hand combat
		hints.add(new Hint(" #6","Почтовые рыцари доминируют поля в Средневековье","src/Assets/Art/Hint/6.PNG", 280)); //Mailed knights dominate fields during Medieval
